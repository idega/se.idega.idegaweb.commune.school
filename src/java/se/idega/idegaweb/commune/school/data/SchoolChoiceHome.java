...
public interface SchoolChoiceHome extends com.idega.data.IDOHome
{
 ...
 public java.util.Collection findChoices(int p0,int p1,int p2,int[] p3,java.lang.String[] p4,java.lang.String p5,int p6, int numberOfEntries, int startingEntry)throws javax.ejb.FinderException,java.rmi.RemoteException;
 public java.util.Collection findByChildId(int p0,int p1)throws javax.ejb.FinderException;
 public java.util.Collection findChoices(int p0,int p1,int p2,java.lang.String[] p3,java.lang.String p4, int p5, int numberOfEntries, int startingEntry)throws javax.ejb.FinderException,java.rmi.RemoteException;
