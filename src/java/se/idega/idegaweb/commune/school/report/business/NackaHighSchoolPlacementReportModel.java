/*
 * $Id: NackaHighSchoolPlacementReportModel.java,v 1.1 2003/12/18 15:08:01 anders Exp $
 *
 ...
 * <p>
 * Last modified: $Date: 2003/12/18 15:08:01 $ by $Author: anders $
 *
				...
				switch (cell.getColumnMethod()) {
					case COLUMN_METHOD_NACKA_COMMUNE:
						if (studentAge == null) {
							...
							value = reportBusiness.getHighSchoolNackaCommunePlacementCount(age, studyPathPrefix, isCompulsory, true);
						}
						break;
					case COLUMN_METHOD_OTHER_COMMUNES:
						if (studentAge == null) {
							...
							value = reportBusiness.getHighSchoolOtherCommunesPlacementCount(age, studyPathPrefix, isCompulsory, true);
						}
						break;
					case COLUMN_METHOD_COUNTY_COUNCIL:
						if (studentAge == null) {
							...
							value = reportBusiness.getHighSchoolCountyCouncilPlacementCount(age, studyPathPrefix, isCompulsory, true);
						}
						break;
					case COLUMN_METHOD_FREE_STANDING:
						if (studentAge == null) {
							...
							value = reportBusiness.getHighSchoolPrivatePlacementCount(age, studyPathPrefix, isCompulsory, true);
						}
						break;
