/*
 * $Id: NackaCC6YearPlacementReportModel.java,v 1.4 2004/01/27 14:30:14 anders Exp $
 *
 ...
 * <p>
 * Last modified: $Date: 2004/01/27 14:30:14 $ by $Author: anders $
 *
...
public class NackaCC6YearPlacementReportModel extends ReportModel {
	...
	private final static String KEY_REPORT_TITLE = KP + "title_nacka_child_care_6_year_placements";
	...
	protected void initReportSize() {
		...
		try {
			...
			schoolTypes.add(new Integer(rb.getAfterSchool6TypeId()));
			schoolTypes.add(new Integer(rb.getFamilyAfterSchool6TypeId()));
			...
			Collection areas = rb.getAfterSchool6Areas();
	...
	protected int getFamilyDaycarePlacementCount(int areaId, int managementType) throws RemoteException {
		...
		int schoolType = rb.getFamilyAfterSchool6TypeId();
	...
	protected int getProviderPlacementCount(int schoolId) throws RemoteException {
		ReportBusiness rb = getReportBusiness();
		int schoolType = rb.getAfterSchool6TypeId();
