...
public interface SchoolChoiceBusiness extends IBOService, CaseBusiness {
	 ...
	 */
	public SchoolChoice createSchoolChangeChoice(int userId, int childId, int school_type_id, int current_school,
			int chosen_school, int schoolYearID, int currentYearID, int method, int workSituation1, int workSituation2,
			String language, String message, boolean keepChildrenCare, boolean autoAssign, boolean custodiansAgree,
			boolean schoolCatalogue, Date placementDate, SchoolSeason season, String extraMessage)
	 ...
	 */
	public List createSchoolChoices(int userId, int childId, int school_type_id, int current_school,
			int chosen_school_1, int chosen_school_2, int chosen_school_3, int schoolYearID, int currentYearID,
			int method, int workSituation1, int workSituation2, String language, String message,
			boolean changeOfSchool, boolean keepChildrenCare, boolean autoAssign, boolean custodiansAgree,
			boolean schoolCatalogue, Date placementDate, SchoolSeason season, String[] extraMessages)
			throws IDOCreateException, java.rmi.RemoteException;
	...
	public List createSchoolChoices(int userId, int childId, int school_type_id, int current_school,
			...
			int method, int workSituation1, int workSituation2, String language, String message,
			boolean changeOfSchool, boolean keepChildrenCare, boolean autoAssign, boolean custodiansAgree,
			boolean schoolCatalogue, Date placementDate, SchoolSeason season, boolean nativeLangIsChecked,
			int nativeLang, String[] extraMessages, boolean useAsAdmin) throws IDOCreateException,
	...
	public List createSchoolChoices(int userId, int childId, int school_type_id, int current_school,
			...
			boolean changeOfSchool, boolean keepChildrenCare, boolean autoAssign, boolean custodiansAgree,
			boolean schoolCatalogue, Date placementDate, SchoolSeason season, boolean nativeLangIsChecked,
			int nativeLang, String[] extraMessages, boolean useAsAdmin, boolean usePriority, int handicraftId)
			throws IDOCreateException, java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#hasPriority
	 */
	public boolean hasPriority(School provider, User parent, User applyingChild) throws java.rmi.RemoteException;
	 ...
	 */
	public boolean noRoomAction(Integer pk, User performer) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#sendMessageToParents
	 */
	public void sendMessageToParents(SchoolChoice application, String nonApplyingSubject, String nonApplyingBody,
			String nonApplyingCode, String applyingSubject, String applyingBody, String applyingCode,
	 ...
	 */
	public void reactivateApplication(int applicationID, int removedSchoolID, boolean hasReceivedPlacementMessage)
	 ...
	 */
	public boolean preliminaryAction(Integer pk, User performer) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#setAsPreliminary
	 */
	public void setAsPreliminary(SchoolChoice choice, User performer) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#setAsInactive
	 */
	public void setAsInactive(SchoolChoice choice, User performer) throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#setChildcarePreferences
	 */
	public void setChildcarePreferences(User performer, int childID, boolean freetimeInThisSchool, String otherMessage,
	 ...
	 */
	public SchoolChoice groupPlaceAction(Integer pk, User performer) throws java.rmi.RemoteException;
	 ...
	 */
	public String getReactivatedMessageSubject() throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getPreliminaryMessageSubject
	 */
	public String getPreliminaryMessageSubject() throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getPreliminaryMessageSubjectNew
	 */
	public String getPreliminaryMessageSubjectNew() throws java.rmi.RemoteException;
	 ...
	 */
	public SchoolChoice findByStudentAndSchoolAndSeason(int studentID, int schoolID, int seasonID)
			throws RemoteException;
	 ...
	 */
	public Collection getApplicantsForSchool(int schoolID, int seasonID, int schoolYearID, String[] validStatuses,
			String searchString, int orderBy, int numberOfEntries, int startingEntry) throws RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getApplicantsForSchool
	 */
	public Collection getApplicantsForSchool(int schoolID, int seasonID, int schoolYearID, int[] choiceOrder,
			String[] validStatuses, String searchString, int orderBy, int numberOfEntries, int startingEntry)
			throws RemoteException;
	 ...
	 */
	public Collection getApplicantsForSchool(int schoolID, int seasonID, int schoolYearID, String[] validStatuses,
			String searchString, int orderBy, int numberOfEntries, int startingEntry, int placementType)
			throws RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getNumberOfApplicantsForSchool
	 */
	public int getNumberOfApplicantsForSchool(int schoolID, int seasonID, int schoolYearID, int[] choiceOrder,
			String[] validStatuses, String searchString) throws RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getNumberOfApplicantsForSchool
	 */
	public int getNumberOfApplicantsForSchool(int schoolID, int seasonID, int schoolYearID, int[] choiceOrder,
			String[] validStatuses, String searchString, int placementType) throws RemoteException;
	 ...
	 */
	public IWTimestamp getSchoolChoiceStartDate() throws RemoteException, FinderException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getSchoolChoiceEndDate
	 */
	public IWTimestamp getSchoolChoiceEndDate() throws RemoteException, FinderException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getSchoolChoiceCriticalDate
	 */
	public IWTimestamp getSchoolChoiceCriticalDate() throws RemoteException, FinderException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getApplicantsForSchoolAndSeasonAndGrade
	 */
	public Collection getApplicantsForSchoolAndSeasonAndGrade(int schoolID, int seasonID, int schoolYearID)
			throws RemoteException;
	 ...
	 */
	public void createSchoolChoiceReminder(String text, java.util.Date eventDate, java.util.Date reminderDate, User user)
	 ...
	 */
	public SchoolChoiceReminder[] findUnhandledSchoolChoiceReminders(Group[] groups) throws RemoteException,
			FinderException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#findSchoolChoiceReminder
	 */
	public SchoolChoiceReminder findSchoolChoiceReminder(int id) throws RemoteException, FinderException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#generateReminderLetter
	 */
	public int generateReminderLetter(int reminderId, MailReceiver[] receivers) throws RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#findAllStudentsThatMustDoSchoolChoiceButHaveNot
	 */
	public MailReceiver[] findAllStudentsThatMustDoSchoolChoiceButHaveNot(SchoolSeason season, SchoolYear[] years,
			boolean isOnlyInCommune, boolean onlyLastGrade) throws java.rmi.RemoteException;
	 ...
	 */
	public int countStudentsWithoutSchoolChoice(SchoolSeason season, SchoolYear year, boolean onlyInCommune,
			boolean onlyLastGrade) throws RemoteException, SQLException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getStudentsWithoutSchoolChoice
	 */
	public MailReceiver[] getStudentsWithoutSchoolChoice(SchoolSeason season, SchoolYear year, boolean onlyInCommune,
			boolean onlyLastGrade) throws RemoteException, FinderException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#findAllStudentsThatMustDoSchoolChoiceButHaveNot
	 */
	public MailReceiver[] findAllStudentsThatMustDoSchoolChoiceButHaveNot(SchoolSeason season, SchoolYear year,
			boolean isOnlyInCommune, boolean isOnlyInSchoolsLastGrade) throws java.rmi.RemoteException;
	 ...
	 */
	public void sendMessageToParentOrChild(SchoolChoice choice, User parent, User child, String subject, String body,
			String contentCode) throws RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getReceiver
	 */
	public User getReceiver(User parent, User child) throws java.rmi.RemoteException;
	 ...
	 */
	public Collection getMandatorySchoolChoiceYears() throws java.rmi.RemoteException;

	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#getConnectedSchoolchoices
	 */
	public List getConnectedSchoolchoices(SchoolChoice selectedChoice) throws java.rmi.RemoteException;
	...
	/**
	 * @see se.idega.idegaweb.commune.school.business.SchoolChoiceBusinessBean#findHandicraftOptions
	 */
