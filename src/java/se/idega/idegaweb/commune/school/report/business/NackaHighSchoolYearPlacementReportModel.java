/*
 * $Id: NackaHighSchoolYearPlacementReportModel.java,v 1.1 2003/12/16 11:33:32 anders Exp $
 *
 ...
 * <p>
 * Last modified: $Date: 2003/12/16 11:33:32 $ by $Author: anders $
 *
	...
	protected Header[] buildRowHeaders() {
		...
		try {
			...
			while (iter.hasNext()) {
				...
				headers[headerIndex] = new Header(studyPath.getDescription(), Header.HEADERTYPE_ROW_NONLOCALIZED_NORMAL, 1);
