...
public interface SchoolChoiceHome extends com.idega.data.IDOHome
{
 ...
 public java.util.Collection findChoices(int p0,int p1,int p2,java.lang.String p3)throws javax.ejb.FinderException,java.rmi.RemoteException, java.rmi.RemoteException;
