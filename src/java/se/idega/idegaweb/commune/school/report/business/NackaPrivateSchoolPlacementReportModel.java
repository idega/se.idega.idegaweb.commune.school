/*
 * $Id: NackaPrivateSchoolPlacementReportModel.java,v 1.1 2004/01/12 12:34:56 anders Exp $
 *
 ...
 * <p>
 * Last modified: $Date: 2004/01/12 12:34:56 $ by $Author: anders $
 *
...
public class NackaPrivateSchoolPlacementReportModel extends ReportModel {
	...
	private final static String KEY_REPORT_TITLE = KP + "title_nacka_private_school_placements";
		...
		if (cell.getColumnMethod() == COLUMN_METHOD_SCHOOL_YEAR) {
			switch (cell.getRowMethod()) {
				case ROW_METHOD_SCHOOL:
					value = getPrivateSchoolPlacementCount(schoolId, schoolYearName);
					break;
				case ROW_METHOD_SUM:
	 ...
	 */
	protected int getPrivateSchoolPlacementCount(int schoolId, String schoolYearName) throws RemoteException {
